...
st.markdown(
    '<div class="subtitle">Positive AI-powered career guidance from your resume</div>',
    unsafe_allow_html=True
)
...
if uploaded_file is not None:
    if st.button("🔍 Analyze Resume", use_container_width=True):
        ...
        try:
            ...
            # TOP JOB ROLES
            # -------------------------------------------------
            st.header("🎯 Jobs You Can Consider Applying For")
            ...
            # SKILLS
            # -------------------------------------------------
            st.header("🛠️ Skills Found in Your Resume")
            ...
            # GROWTH SKILLS
            # -------------------------------------------------
            st.header("📚 Skills That Can Increase Your Opportunities")
            ...
            # STRENGTHS
            # -------------------------------------------------
            st.header("💪 Your Resume Strengths")
            ...
            # RESUME IMPROVEMENT
            # -------------------------------------------------
            st.header("🚀 Simple Ways to Make Your Resume Stronger")
